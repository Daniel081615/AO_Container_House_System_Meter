...
enum DefineModbusSoilSensorCmd{
    ...
    MBSSCMD_SET_K_VALUE,
    MBSSCMD_SET_EC_COEF,
    MBSSCMD_SET_SALINITY_COEF,
    MBSSCMD_SET_TDS_COEF,
    MBSSCMD_SET_TEMP_CALIB,
    MBSSCMD_SET_MOISTURE_CALIB,
    MBSSCMD_SET_EC_CALIB,
    MBSSCMD_SET_PH_CALIB,		
    MBSSCMD_SET_FERT_COEF,
    MBSSCMD_SET_FERT_OFFSET,
    MBSSCMD_SET_N_COEF,
    MBSSCMD_SET_N_OFFSET,
    MBSSCMD_SET_P_COEF,
    MBSSCMD_SET_P_OFFSET,
    MBSSCMD_SET_K_COEF,
    MBSSCMD_SET_K_OFFSET,		
    MBSSCMD_GET_DEVICE_ADDRESS,
    MBSSCMD_SET_DEVICE_ADDRESS,
    MBSSCMD_GET_BAUD_RATE,
    MBSSCMD_SET_BAUD_RATE,
};
...
typedef struct {
    ...
    float Phosphorus_Coef;
    int16_t Phosphorus_Deviation;

    float Potassium_Coef;
